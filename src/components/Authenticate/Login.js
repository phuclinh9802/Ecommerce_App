...
import { ACCOUNT_FOUND_MESSAGE, ACCOUNT_NOT_FOUND_MESSAGE } from "../../constants/messages";
import { LOG_IN } from "../../constants/auth";

const Login = ({ isOpen, onClose, onOpen, loginUser }) => {
    const [userLogin, setUserLogin] = useState({ email: "", password: "", errors: {} })
                    ...
                    <ModalBody pb={6}>
                        ...
                        <form id="login-form" noValidate onSubmit={handleSubmit}>
                            <FormControl isRequired>
                                ...
                                <Input className={classnames("", { invalid: errors.email || errors.emailnotfound })} name="email" ref={initialRef} onChange={handleChange} value={userLogin.email} error={errors.email} type="email" placeholder="johndoe@gmail.com" />
                            ...
                            <FormControl isRequired>
                                ...
                                <Input className={classnames("", { invalid: errors.password || errors.passwordincorrect })} name="password" onChange={handleChange} value={userLogin.password} error={errors.password} type="password" placeholder="Password" required />
                                <span className="red-text" style={{ color: "red" }}>
                                    {errors.password}
